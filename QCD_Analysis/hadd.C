...
void hadd() {
  ...
  // ************************************************************
  // List of Files
  //FileList->Add( TFile::Open("pj_0_15.root") );   // 1, too few statistics
  //FileList->Add( TFile::Open("pj_15_20.root") );  // 2
  FileList->Add( TFile::Open("The_QCD_100-250.root") );  // 3
  FileList->Add( TFile::Open("The_QCD_250-500.root") );  // 4
  FileList->Add( TFile::Open("The_QCD_500-1000.root") );  // 5
  FileList->Add( TFile::Open("The_QCD_1000-2500.root") ); // 6
  FileList->Add( TFile::Open("The_QCD_2500-4000.root") );// 7
  FileList->Add( TFile::Open("The_QCD_4000-6000.root") );// 8
  FileList->Add( TFile::Open("The_QCD_6000-Inf.root") );// 9
